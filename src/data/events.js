...
export const events = [
  {
    ...
    tickets: [
      { name: 'General', price: 38, perks: 'Acceso al concierto y zonas comunes' },
      { name: 'Fast Pass', price: 58, perks: 'Ingreso preferente y bebida de bienvenida' },
      { name: 'VIP Booth', price: 120, perks: 'Mesa compartida, backstage tour y merch exclusivo' },
    ],
  },
  {
    id: 'founders-summit',
  ...
  },
  {
    ...
    title: 'After Dark Gallery Walk',
    category: 'Arte',
    date: '2026-06-13T19:00:00',
    location: 'Warehouse District, Los Ángeles',
    price: 31,
  ...
  {
    id: 'reset-retreat',
    title: 'Reset Morning Retreat',
    category: 'Bienestar',
    date: '2026-06-20T07:30:00',
    location: 'Ocean Deck, San Diego',
    price: 42,
  ...
  },
  {
    ...
    location: 'North Pier Studio, Seattle',
    price: 18,
